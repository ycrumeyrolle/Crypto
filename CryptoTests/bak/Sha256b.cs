...
namespace Sha256Tests
{
    public class Sha256b
    {
        ...
        private Vector256<uint> sha256_transform(Vector256<uint> state, ref byte currentBlock)
        {
            ...
            //    w[i + 1] = w[i - 15] + Sigma0(w[i - 14]) + w[i - 6] + Sigma1(w[i - 1]);
            //}
            ...
            Round(a, b, c, ref d, e, f, g, ref h, w[0], k[0]);
            Round(h, a, b, ref c, d, e, f, ref g, w[1], k[1]);
            Round(g, h, a, ref b, c, d, e, ref f, w[2], k[2]);
            Round(f, g, h, ref a, b, c, d, ref e, w[3], k[3]);
            Round(e, f, g, ref h, a, b, c, ref d, w[4], k[4]);
            Round(d, e, f, ref g, h, a, b, ref c, w[5], k[5]);
            Round(c, d, e, ref f, g, h, a, ref b, w[6], k[6]);
            Round(b, c, d, ref e, f, g, h, ref a, w[7], k[7]);

            Round(a, b, c, ref d, e, f, g, ref h, w[8], k[8]);
            Round(h, a, b, ref c, d, e, f, ref g, w[9], k[9]);
            Round(g, h, a, ref b, c, d, e, ref f, w[10], k[10]);
            Round(f, g, h, ref a, b, c, d, ref e, w[11], k[11]);
            Round(e, f, g, ref h, a, b, c, ref d, w[12], k[12]);
            Round(d, e, f, ref g, h, a, b, ref c, w[13], k[13]);
            Round(c, d, e, ref f, g, h, a, ref b, w[14], k[14]);
            Round(b, c, d, ref e, f, g, h, ref a, w[15], k[15]);

            for (int i = 16; i < 64; i += 8)
            {
                w[0] = Sigma1(w[14]) + w[0] + w[9] + Sigma0(w[1]);
                Round(a, b, c, ref d, e, f, g, ref h, w[0], k[i + 0]);
                w[1] = Sigma1(w[15]) + w[1] + w[10] + Sigma0(w[2]);
                Round(h, a, b, ref c, d, e, f, ref g, w[1], k[i + 1]);
                w[2] = Sigma1(w[0]) + w[2] + w[11] + Sigma0(w[3]);
                Round(g, h, a, ref b, c, d, e, ref f, w[2], k[i + 2]);
                w[3] = Sigma1(w[1]) + w[3] + w[12] + Sigma0(w[4]);
                Round(f, g, h, ref a, b, c, d, ref e, w[3], k[i + 3]);
                w[4] = Sigma1(w[2]) + w[4] + w[13] + Sigma0(w[5]);
                Round(e, f, g, ref h, a, b, c, ref d, w[4], k[i + 4]);
                w[5] = Sigma1(w[3]) + w[5] + w[14] + Sigma0(w[6]);
                Round(d, e, f, ref g, h, a, b, ref c, w[5], k[i + 5]);
                w[6] = Sigma1(w[4]) + w[6] + w[15] + Sigma0(w[7]);
                Round(c, d, e, ref f, g, h, a, ref b, w[6], k[i + 6]);
                w[7] = Sigma1(w[5]) + w[7] + w[0] + Sigma0(w[8]);
                Round(b, c, d, ref e, f, g, h, ref a, w[7], k[i + 7]);
            }
